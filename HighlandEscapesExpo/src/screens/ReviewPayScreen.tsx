    ...
    <View style={styles.container}>
      ...
      >
          ...
          <View style={styles.paymentOptions}>
            ...
            >
              <View style={styles.paymentOptionContent}>
                <MaterialIcons name="credit-card" size={24} color={selectedPayment === 'card' ? colors.primary : colors.slate500} />
            ...
            >
              <View style={styles.paymentOptionContent}>
                <MaterialIcons name="apple" size={24} color={selectedPayment === 'apple' ? colors.primary : colors.slate500} />
                <View style={styles.paymentOptionText}>
        ...
        <View style={styles.securityNotice}>
          <MaterialIcons name="lock" size={20} color={colors.green600} />
