          ...
          <>
            {upcomingTrips.length > 0 ? (
                  ...
                  <View style={styles.tripContent}>
                    <View style={styles.tripHeader}>
                      <View style={styles.statusBadge}>
                        <MaterialIcons name="check-circle" size={12} color={colors.green600} />
              ...
              <View style={styles.emptyState}>
                <MaterialIcons name="luggage" size={64} color={colors.slate300} />
          ...
          <>
            {pastTrips.map((trip) => (
              ...
              >
                ...
                <View style={styles.tripContent}>
                  <View style={styles.statusBadge}>
                    <MaterialIcons name="history" size={12} color={colors.slate500} />
