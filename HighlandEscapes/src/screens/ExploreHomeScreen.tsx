    ...
    >
      <View style={styles.tripImageContainer}>
        ...
        >
          <TouchableOpacity style={styles.favoriteButton}>
            <Icon name="favorite-border" size={18} color={colors.textWhite} />
          </TouchableOpacity>
      ...
      <View style={styles.tripContent}>
        ...
        <View style={styles.tripMeta}>
          <Icon name="calendar-today" size={16} color={colors.slate500} />
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + spacing[2] }]}>
        ...
        <View style={styles.headerTitle}>
          <Icon name="travel-explore" size={24} color={colors.primary} />
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>
              Featured Trip{' '}
              <Icon name="star" size={18} color={colors.amber500} />
            </Text>
          </View>
          <TouchableOpacity 
          ...
          >
            ...
            >
              ...
              <TouchableOpacity style={styles.featuredFavorite}>
                <Icon name="favorite-border" size={24} color={colors.textWhite} />
              </TouchableOpacity>
              <View style={styles.featuredContent}>
                ...
                <View style={styles.featuredMeta}>
                  <Icon name="calendar-month" size={16} color={colors.slate200} />
