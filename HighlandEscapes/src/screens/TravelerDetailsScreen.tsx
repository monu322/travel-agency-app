          ...
          <View style={styles.section}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputContainer}>
                <Icon name="person" size={20} color={colors.slate400} style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
                  value={fullName}
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputContainer}>
                <Icon name="mail" size={20} color={colors.slate400} style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
                  value={email}
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputContainer}>
                <Icon name="phone" size={20} color={colors.slate400} style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
                  value={phone}
      ...
      <View style={[styles.footer, { paddingBottom: insets.bottom + spacing[4] }]}>
        ...
        >
          <View style={[styles.checkbox, agreedToTerms && styles.checkboxChecked]}>
            {agreedToTerms && <Icon name="check" size={16} color={colors.textWhite} />}
          </View>
        ...
        >
          ...
          <Icon name="arrow-forward" size={24} color={colors.textWhite} />
        </TouchableOpacity>
      </View>
    </View>
  );
