        ...
        <View style={styles.content}>
          ...
          <View style={styles.titleSection}>
            ...
            <View style={styles.ratingRow}>
              <Icon name="star" size={20} color={colors.yellow500} />
          ...
          <View style={styles.summaryCard}>
            <View style={styles.summaryHeader}>
              ...
              <View style={styles.urgentBadge}>
                <Icon name="local-fire-department" size={14} color={colors.red500} />
          ...
          <View style={styles.section}>
            ...
            <View style={styles.meetingCard}>
                ...
                >
                  ...
                  <View style={styles.mapPinContainer}>
                    <View style={styles.mapPin}>
                      <Icon name="location-on" size={18} color={colors.textWhite} />
                    </View>
              ...
              <View style={styles.addressContainer}>
                <Icon name="storefront" size={24} color={colors.slate400} />
          ...
          <View style={styles.policyCard}>
            <Icon name="verified-user" size={24} color={colors.slate500} />
