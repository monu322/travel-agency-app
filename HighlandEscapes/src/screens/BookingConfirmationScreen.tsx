      ...
      >
        ...
        <View style={styles.successContainer}>
          <View style={styles.successCircle}>
            <Icon name="check" size={48} color={colors.textWhite} />
          </View>
        ...
        <View style={styles.bookingCard}>
          <View style={styles.bookingHeader}>
            ...
            <View style={styles.confirmedBadge}>
              <Icon name="verified" size={14} color={colors.green600} />
          ...
          <View style={styles.tripPreview}>
            ...
            <View style={styles.tripInfo}>
              ...
              <View style={styles.tripMeta}>
                <Icon name="person" size={16} color={colors.slate500} />
          ...
          <View style={styles.paymentSummary}>
            ...
            <View style={styles.paymentRow}>
              ...
              <View style={styles.paymentMethod}>
                <Icon name="credit-card" size={16} color={colors.slate500} />
